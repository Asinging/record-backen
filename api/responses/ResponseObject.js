 ...
 *     // -or-
 *     return res.ResponseObject(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function ResponseObject(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.ResponseObject()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.ResponseObject()` called with an Error:', optionalData);
